...
user_4 = User.create(name: "Alexandre", bio: "Bonjour à tous, ma passion pour la fondation scp m'a mené à l'attention du détail, je fais principalment game master", age: 29, genre: "M", email: "ale@game.com", password: "123456") 
...
player_3 = Player.create(category: "Role Playing games", user: user_3)
player_4 = Player.create(category: "Role Playing games", user: user_4)
player_5 = Player.create(category: "Video games", user: user_5)
player_6 = Player.create(category: "Card games", user: user_6)
player_7 = Player.create(category: "Board games", user: user_7)
player_8 = Player.create(category: "Video games", user: user_8)
