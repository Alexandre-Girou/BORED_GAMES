...
player_2 = Player.create(category: "Card games", nickname: "Jul", user_id: 2)
player_3 = Player.create(category: "Role Playing games", nickname: "Dym", user_id: 3)
player_4 = Player.create(category: "Role Playing games", nickname: "Ale", user_id: 4)
player_5 = Player.create(category: "Video games", nickname: "Cha", user_id: 5)
