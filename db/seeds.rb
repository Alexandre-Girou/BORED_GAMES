...
player_1 = Player.create(category: "Board-Games", nickname: "Lom", price: 9999, user: user_1)
player_2 = Player.create(category: "Card-Games", nickname: "Jul", price: 9999, user: user_2)
player_3 = Player.create(category: "Role-Playing-Games", nickname: "Dym", price: 9999, user: user_3)
player_4 = Player.create(category: "Role-Playing-Games", nickname: "Ale", price: 9999, user: user_4)
player_5 = Player.create(category: "Video-Games", nickname: "Cha", price: 9999, user: user_5)
player_6 = Player.create(category: "Card-Games", nickname: "Mar", price: 9999, user: user_6)
player_7 = Player.create(category: "Board-Games", nickname: "Obi", price: 9999, user: user_7)
player_8 = Player.create(category: "Video-Games", nickname: "Dog", price: 9999, user: user_8)
player_9 = Player.create(category: "Board-Games", nickname: "Dym2", price: 9999, user: user_3)
